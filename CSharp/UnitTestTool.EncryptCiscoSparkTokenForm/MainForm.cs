...
namespace UnitTestTool.EncryptCiscoSparkTokenForm
{
    public partial class MainForm : Form
    {
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            this.textBoxPath.Text = String.Format("{0}{1}.thrzn41{1}unittest{1}spark", this.dirInfo.FullName, Path.DirectorySeparatorChar);
        ...
        private async void buttonExportToken_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MessageBox.Show(ResourceMessage.AppMessages.SparkTokenExported);
            }
            finally
            {
